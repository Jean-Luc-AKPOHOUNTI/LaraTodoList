                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <input v-model="form.title"
                                           ...
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-sm"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea v-model="form.description"
                                              ...
                                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-sm resize-none"
                                ...
                                <div>
                                    ...
                                    <select v-model="form.status"
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-sm bg-white"
                            ...
                            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-6 border-t border-gray-200">
                                ...
                                <button type="submit"
                                        ...
                                        class="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2">
                                    ...
                                    <span>{{ form.processing ? 'Création en cours...' : 'Créer la tâche' }}</span>
                                </button>
                            </div>
                        </form>
                    </div>
...
<script setup>
// Import des composants et fonctions nécessaires depuis Inertia et le layout authentifié
import { Head, Link, useForm } from '@inertiajs/vue3'
import AuthenticatedLayout from '@/Layouts/AuthenticatedLayout.vue'

// Initialisation du formulaire avec useForm et les champs par défaut
// - title: titre de la tâche (requis)
// - description: description détaillée de la tâche (optionnel)
// - date: date d'échéance (optionnel)
// - status: statut initial 'todo' par défaut
const form = useForm({
    title: '',
    description: '',
    date: '',
...
// Envoie une requête POST vers la route 'tasks.store' avec les données du formulaire
const submit = () => {
